  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) group-data-[collapsible=icon]:hidden bg-transparent transition-[width] duration-500 ease-linear",
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("size-7 px-2 cursor-pointer", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn("bg-sidebar-border hidden mx-2 w-auto", className)}
      {...props}
    />
  )
}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // Change this to use opacity instead of margin and hidden
