    ...
    <div className="w-full h-screen flex items-center justify-center p-4">
      <div className="w-full space-y-8 text-center">
        <div className="space-y-2">
          <h1 className="text-lg font-bold text-white">Welcome to <span className="font-silkscreen text-white text-2xl">PxT3.chat</span></h1>
        ...
        <div>
          <Link href="/">
            <Button
              variant="ghost"
              className="text-zinc-400 h-10 cursor-pointer hover:text-white hover:bg-zinc-800 transition-colors"
            >
